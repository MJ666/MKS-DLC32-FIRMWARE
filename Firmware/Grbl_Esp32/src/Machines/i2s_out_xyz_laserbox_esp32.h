...
#define MACHINE_NAME                "Atomstack X20"
#define BOARD_NAME                  "Board:LaserBox ESP32 V1.0"

#define FW_NAME                     "V1.1(8M.H35.20230220)"
...
#define DEFAULT_SPINDLE_FREQ        1000 // 8000.0   // 1KHz
